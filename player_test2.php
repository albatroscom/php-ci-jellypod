...
<iframe id="logfr" name="logfr" border="0" frameborder="0" width="0" height="0" src="about:blank" style="display:none"></iframe>
	<div class="player">
		<div>
			<div id="myElement"  >
			<a href="javascript:aaa();"><img src="http://imgcdn.pandora.tv/jellypod/images/main/player.gif" alt="player"></a></div>
		</div>
	</div>
...
//playerSet.startPlay('userid','channelid','prgid','categ','playtype' ,'playUser' ,'refer' ,'title_str', 'file_url' ,'img_url','like');
			...
			console.log(rsi.list[0]['imgurl']);
			console.log("like =" + rsi.list[0]['like']);
//			console.log("/----------------------------------/")
...
function aaa(){
				...
				//playerSet.startPlay('','1','73','1','Video','0','Video','제목','http://218.50.190.34/jellypod.com/vld/jellypod/1/92/20130729135026507u2fg97mm7zanx.mp4','http://218.50.190.34/flv/jellypod/1/92/20130729135026507u2fg97mm7zanx.mp4','http://218.50.190.34/jellypod.com/sd/jellypod/1/92/20130729135026507u2fg97mm7zanx.mp4','http://218.50.190.34/jellypod.com/hd/jellypod/1/92/20130729135026507u2fg97mm7zanx.mp4', '','N' );

				playerSet.startPlay('','1','73','1','Video','0','Video','제목','http://trans-idx.jellypod.com/jellypod.com/vld/jellypod/1/92/20130729135026507u2fg97mm7zanx.mp4','http://218.50.190.34/flv/jellypod/1/92/20130729135026507u2fg97mm7zanx.mp4','http://218.50.190.34/jellypod.com/sd/jellypod/1/92/20130729135026507u2fg97mm7zanx.mp4','http://218.50.190.34/jellypod.com/hd/jellypod/1/92/20130729135026507u2fg97mm7zanx.mp4', '','N' );
}

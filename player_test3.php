...
//playerSet.startPlay('userid','channelid','prgid','categ','playtype' ,'playUser' ,'refer' ,'title_str', 'file_url' ,'img_url','like');
			...
			console.log(rsi.list[0]['img_url']);
			console.log(rsi.list[0]['like']);
...
function aaa(){
alert('시작');
				playerSet.startPlay('','1','73','1',' Audio','0',' Audio','제목','http://trans-idx.jellypod.com/jellypod2.com/audiouhd/jellypod/69/58/20130801102032554l14ia3z6sj8pc.mp3','http://movies.apple.com/media/kr/iphone/2012/212b67-cd9a-e384-85a58600a9/tours/feature/iphone5-feature-keynote-kr-20120912_848x480.mp4','http://movies.apple.com/media/kr/iphone/2012/212b67-cd9a-e384-85a58600a9/tours/feature/iphone5-feature-keynote-kr-20120912_848x480.mp4','http://movies.apple.com/media/kr/iphone/2012/212b67-cd9a-e384-85a58600a9/tours/feature/iphone5-feature-keynote-kr-20120912_848x480.mp4', '','N' );
